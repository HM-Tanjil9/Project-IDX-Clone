...
// export const handleTerminalCreation = (socket, ws) => {
//     Container.exec({
//         Cmd: ["/bin/bash"],
//         AttachStdin: true,
//         AttachStdout: true,
...
//     let nextDataType = null; // store the type of next message 
//     let nextDataLength = null; // store the length of next message
...
//                 nextDataType = header.readUInt32BE(0); // first 4 bytes present the type of message
//                 nextDataLength = header.readInt32BE(4); // next 4 bytes represent the length of message

//                 processStreamData(); 
//             } else {
//                 if(buffer.length >= nextDataLength) {
//                     const content = bufferSlicer(nextDataLength); // get the message content
//                     ws.send(content);
//                     nextDataType = null;
//                     processStreamData(); 
//                 }
